...
HashKey PolyglotBook::hash(const Position& position)
{
    ...
    if (position.enpassant_square() != NO_SQUARE)
    {
        ...
        if (position.side_to_move() == WHITE)
            possible_attackers = shift<SOUTHEAST>(enpassant_bb) | shift<SOUTHWEST>(enpassant_bb);
        else
            possible_attackers = shift<NORTHEAST>(enpassant_bb) | shift<NORTHWEST>(enpassant_bb);
