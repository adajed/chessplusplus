...
TEST_F(SearchTest, mate_in_1)
{
    using TestCase = std::tuple<std::string, Move>;

    const std::vector<TestCase> test_cases = {
        {"4r1k1/pp3ppp/3P1n2/8/8/2QB1bP1/PPPK1P1q/R4R2 b - - 0 1", create_move(SQ_H2, SQ_H6)},
        {"r1b1k1nr/pppp1pp1/5q2/3P4/4P1Kp/5B1P/PPP3P1/RNBQ3R b kq - 0 1", create_move(SQ_D7, SQ_D6)},
